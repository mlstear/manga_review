...
public class ReviewCreateServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(_token != null && _token.equals(request.getSession().getId())) {
            ...
            r.setComic((Comic)request.getSession().getAttribute("comic"));
            r.setPoster((Poster)request.getSession().getAttribute("login_poster"));
            ...
            if(errors.size()>0){
                ...
                request.getSession().removeAttribute("comic");
